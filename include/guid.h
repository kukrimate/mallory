...
extern EFI_GUID LINUX_EFI_INITRD_MEDIA_GUID;
#define LINUX_EFI_INITRD_MEDIA_GUID_INITIALIZER {0x5568e427, 0x68fc, 0x4f3d, { 0xac, 0x74, 0xca, 0x55, 0x52, 0x31, 0xcc, 0x68 } }
